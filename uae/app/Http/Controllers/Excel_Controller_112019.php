...

{
  ...
  public function mis_bill_report(Product_master $product_master){
        ...
        $product_outs = DB::select(DB::raw(" select '1.January 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  ...
  union all
  select '2.February 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '3.March 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '4.April 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '5.May 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '6.June 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '7.July 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '8.August 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '9.September 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '10.October 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '11.November 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
  ...
  union all
  select '12.December 2018' as month,sum(final.total_amt)total_amt,sum(final.total_weight)total_weight from(
  select sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight,is_bill,
  (select sum(net_amt) from bill_tran WHERE bill_tran.bill_no=is_bill) total_amt
  FROM `product_out` 
  WHERE `is_bill` <>0
...
`category_out`='F' and YEAR(date)=2018 and MONTH(date)=1)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and YEAR(date)=2018 and MONTH(date)=2)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and YEAR(date)=2018 and MONTH(date)=3 )total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where 
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and YEAR(date)=2018 and MONTH(date)=4 )total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where 
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and MONTH(date)=5 and YEAR(date)=2018 )total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where 
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and MONTH(date)=6 and YEAR(date)=2018)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and MONTH(date)=7 and YEAR(date)=2018)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where 
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and MONTH(date)=8 and YEAR(date)=2018)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and MONTH(date)=9 and YEAR(date)=2018)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where 
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and MONTH(date)=10 and YEAR(date)=2018)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where 
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and MONTH(date)=11 and YEAR(date)=2018)total,
...
(SELECT 'SG- + HG-',sum(case when (`unit` = 'kg') then (`quantity`) else (`quantity`*.455) end) as total_weight FROM `product_out` where 
(`title` like  'WG-%' or `title` like  'ECO+%' or `title` like  'WB-%' or `title` like  'MG-%' or `title` like  'SP-%' or `title` like  'SG-%' or `title` like  'HG-%' or `title` like  'BB-%') and
`category_out`='F' and YEAR(date)=2018 and MONTH(date)=12 )total,
