			  ...
			  <div class="form-group">
			    ...
			    {!! Form::select('designation_id[]', $designations, isset($selected_designation) ? $selected_designation : '',['class'=>'form-control input-xlarge select2me','placeholder'=>'Select Designation','multiple' => true])!!}
			  </div>
			  <div class="form-group">
