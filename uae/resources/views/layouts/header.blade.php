			...
			<button class="button-menu-mobile show-sidebar">
				...
				<div class="navbar navbar-default" >
					<div class="container" style="padding-right:0px;">
						...
						<!-- Navbar collapse -->	
						<div class="navbar-collapse collapse" style="background-color:#1A404F;">
							...
							@if(Entrust::hasRole('admin') || Entrust::can('manage_custom_field') || Entrust::can('manage_sms_template') || Entrust::can('manage_template'))
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">{!! trans('messages.Hello') !!}, <strong>{!! Auth::user()->first_name !!}</strong> <i class="fa fa-chevron-down i-xs"></i></a>
									<ul class="dropdown-menu animated half flipInX">
