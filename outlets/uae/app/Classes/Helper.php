...
use Services_Twilio_RestException;
	...
	Class Helper{
		...
		{
			$branch_name= DB::table('branches')->where('id','=',Auth::user()->branch_id)->first();
		...
		public static function getBranchAddress()
		{
			$branch_name= DB::table('branches')->where('id','=',Auth::user()->branch_id)->first();
			return $branch_name->address;
		}
		public static function getBranchPhone()
		{
			$branch_name= DB::table('branches')->where('id','=',Auth::user()->branch_id)->first();
			return $branch_name->phone;
		}
		public static function getBranchZip()
		{
			$branch_name= DB::table('branches')->where('id','=',Auth::user()->branch_id)->first();
			return $branch_name->zip;
		}
		...
		public static function getAvatar($id){
			...
			if(isset($profile->photo))
				...
				echo '<img src="/uploads/user/'.$profile->photo.'" class="media-object img-circle profile-avatar" style=" float:left;" alt="User avatar" data-toggle="tooltip" title="'.$tooltip.'">';
