...
<body>
<?php $branch_id=\App\Classes\Helper::get_branch_id(); ?>
    <div class="container" >
    ...
    @if($branch_id==2)
                    ...
                    <img src="MAJ_pad-1.jpg" height="120px" />
        ...
        <table>
            <tr>
                ...
                <td colspan="6" >
                    ...
                    <center style="font-size:15px;letter-spacing: 4px;"><b> {!! \App\Classes\Helper::getBranchName() !!} Branch</b></center>
                    <center>{!! \App\Classes\Helper::getBranchAddress() !!}</center>
                   
                    <center>{!! \App\Classes\Helper::getBranchZip() !!} </center>
