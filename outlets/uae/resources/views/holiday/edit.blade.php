@extends('layouts.default')
	...
	@section('content')
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="the-notes info"><h4>{!! trans('messages.Help') !!}</h4>Here you can edit the department name & its description. Keep in mind that department name cannot be same as another department name.</div>
			</div>
		</div>
