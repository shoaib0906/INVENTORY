@extends('layouts.default')
	...
	@section('content')
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="the-notes info"><h4>{!! trans('messages.Help') !!}</h4> Notices are the instructions given by company to the employees. You can send notices to selected designations or to all the employees.
