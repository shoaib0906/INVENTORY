				...
				<div class="panel panel-default col-sm-12"  style="background-color:#95a5a6;padding-bottom:20px;">
					...
					{!! Form::model($employee,['method' => 'PATCH','route' => ['employee.update',$employee->id] ,'class' => 'employee-form form-horizontal']) !!}
                          ...
                          <div class="form-group">
						    ...
						    {!! Form::label('last_name','Role',['class' => 'col-sm-2 control-label'])!!}

						    <div class="col-sm-10">
                                	{!! Form::select('role', [null=>'Please Select'] + $roles,isset($employee->emp_type) ? $employee->emp_type : '',['class'=>'form-control input-xlarge select2me','placeholder'=>'Select Role'])!!}
