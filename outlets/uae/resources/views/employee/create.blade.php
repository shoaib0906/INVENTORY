	...
	@section('content')
		...
		<div class="row" >
			...
			<div class="col-sm-12" style="margin: 10px;">
				...
				<div class="panel panel-default col-sm-12"  style="">
					<div class="panel-heading" style="">
						<center><strong> Create User  </strong></center>
					</div>
					<br/>
					...
					<form method="POST" action="{{url('auth/register')}}" accept-charset="UTF-8" class="form-horizontal employee-form">
    				  	...
    				  	<div class="form-group">
						    ...
						    {!! Form::label('alias_id','Select Branch',['class' => 'col-sm-2 control-label'])!!}

						    <div class="col-sm-10">

							{!! Form::select('branch_id', [null=>'Please Select Branch'] + $branches,isset($branches->id) ? $branches->id : '',['class'=>'form-control input-xlarge select2me','placeholder'=>'Select Alias'])!!}
						  ...
						  <div class="form-group">
						    ...
						    {!! Form::label('alias_id','Select Department',['class' => 'col-sm-2 control-label'])!!}
						    ...
						    {!! Form::label('alias_id','Role of that branch',['class' => 'col-sm-2 control-label'])!!}

						    <div class="col-sm-10">

							<select class="select2me form-control input-xlarge " name="role">
