...
<style type="text/css">
	#sidebar-menu  a
	{
		...
		<div class="left side-menu">
            ...
            <div class="body rows scroll-y" style="background-color:;">
				...
				@endif
					...
					<div id="sidebar-menu">
						...
						<ul>
							...
							<li><a  href="{!! URL::to('/') !!}"><i class="fa fa-home icon">
								
							</i> {!! trans('messages.Dashboard') !!}</a></li>
...
@if(Entrust::can('customer'))
							<li><a href="{!! URL::to('/customer') !!}">
									<i class="fa fa-user  icon"></i>Customer </a>
							</li>
							...
							@endif
                                    ...
                                    <li><a href=""><i class="fa fa-bar-chart icon"></i><i class="fa fa-angle-double-down i-right"></i>MIS Report</a>
        								...
        								<ul>
        									...
        									<li><a href="{!! URL::to('/mis_report') !!}"><i class="fa fa-angle-right"></i> MIS Report 2018 </a></li>
  ...
  <div class="footer rows animated fadeInUpBig">
				...
				<div class="logo-brand header sidebar rows">
					...
					<div class="logo">
						...
						<h1 style="color:white;"><center<a style="color:white;letter-spacing:2px;" href="{!! URL::to('/') !!}">
						 {!! \App\Classes\Helper::getBranchName() !!} Branch</a></center> </h1>
