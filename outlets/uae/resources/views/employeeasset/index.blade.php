@extends('layouts.default')
	...
	@section('content')
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="box-info">
					<h2><strong>{!! trans('messages.Listing All') !!}</strong> {!! trans('messages.Employee Assets') !!}
                    ...
                    <div class="additional-btn">
						  ...
						  <ul class="dropdown-menu pull-right animated half fadeInDown" role="menu" aria-labelledby="dropdownMenu4">
							<li role="presentation"><a role="menuitem" tabindex="-1" href="/employeeasset/create">{!! trans('messages.New Employee Asset') !!}</a></li>
						  </ul>
					</div>
                    @endif
                    </h2>
