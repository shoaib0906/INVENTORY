var Validate = function () {
	...
	var handleEmployee = function() {
   		...
   		$('.employee-form').validate({
			...
			jQuery(document).on("change", "#emptype", function(e) {
				var settings = $('.employee-form').validate().settings;
				if($(this).val()=="0") {
					$("#divemptype").addClass("hide");
					$("#emp_type").val(0);
	...
	var handleDependent = function() {

		$( "#depexpiry_date" ).datepicker({format: 'yyyy-mm-dd',autoclose: true});
		$( "#issue_date" ).datepicker({format: 'yyyy-mm-dd',endDate: new Date(),autoclose: true});		
	...
	var handleEmployeeAsset = function() {

		$( "#issue_date" ).datepicker({format: 'yyyy-mm-dd',endDate: new Date(),autoclose: true});
		$( "#return_date" ).datepicker({format: 'yyyy-mm-dd',endDate: new Date(),autoclose: true});

   		$('.employeeasset-form').validate({
    ...
    return {
        ...
        init: function () {
			...
			//by Dev@4489
			//Dependent Edit link
			jQuery(document).on("click", ".dependent_edit", function(e) {
	            var dplink = jQuery(this).attr("href"); 
	            e.preventDefault(); 
				$.ajax({
					type: "GET",
					url : dplink,
					success : function(data){
						$("#dependent-eform").html(data);						
						handleDependent();
					}
				},"html");
				return false;
